...
proc create_root_design { parentCell } {
  ...
  set vauxn2_0 [ create_bd_port -dir I vauxn2_0 ]
  set vauxn3_0 [ create_bd_port -dir I vauxn3_0 ]
  set vauxn4_0 [ create_bd_port -dir I vauxn4_0 ]
  set vauxn5_0 [ create_bd_port -dir I vauxn5_0 ]
  set vauxp0_0 [ create_bd_port -dir I vauxp0_0 ]
  set vauxp1_0 [ create_bd_port -dir I vauxp1_0 ]
  set vauxp2_0 [ create_bd_port -dir I vauxp2_0 ]
  set vauxp3_0 [ create_bd_port -dir I vauxp3_0 ]
  set vauxp4_0 [ create_bd_port -dir I vauxp4_0 ]
  set vauxp5_0 [ create_bd_port -dir I vauxp5_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.c_num_mm2s_channels {6} \
   CONFIG.c_num_s2mm_channels {6} \
...
0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0}\
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins processing_system7_0/S_AXI_GP0_ACLK] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_100M/dcm_locked]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  ...
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  ...
  connect_bd_net -net vauxn2_0_1 [get_bd_ports vauxn2_0] [get_bd_pins xadc_wiz_0/vauxn2]
  connect_bd_net -net vauxn3_0_1 [get_bd_ports vauxn3_0] [get_bd_pins xadc_wiz_0/vauxn3]
  connect_bd_net -net vauxn4_0_1 [get_bd_ports vauxn4_0] [get_bd_pins xadc_wiz_0/vauxn4]
  connect_bd_net -net vauxn5_0_1 [get_bd_ports vauxn5_0] [get_bd_pins xadc_wiz_0/vauxn5]
  ...
  connect_bd_net -net vauxp2_0_1 [get_bd_ports vauxp2_0] [get_bd_pins xadc_wiz_0/vauxp2]
  connect_bd_net -net vauxp3_0_1 [get_bd_ports vauxp3_0] [get_bd_pins xadc_wiz_0/vauxp3]
  connect_bd_net -net vauxp4_0_1 [get_bd_ports vauxp4_0] [get_bd_pins xadc_wiz_0/vauxp4]
  connect_bd_net -net vauxp5_0_1 [get_bd_ports vauxp5_0] [get_bd_pins xadc_wiz_0/vauxp5]
  ...
  set_property PFM.CLOCK {FCLK_CLK0 {id "1" is_default "true" proc_sys_reset "/rst_ps7_0_50M" status "fixed" freq_hz "100000000"}} [get_bd_cells /processing_system7_0]
